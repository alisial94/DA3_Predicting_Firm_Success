...
# data_train <- data[train_indices, ]
 ...
 #                 $fast_growth_f)
# 
#saveRDS(data_train,"Data/Clean/data_train_m.RDS")
 # saveRDS(data_holdout,"Data/Clean/data_holdout_m.RDS")



data_train <- readRDS("Data/Clean/data_train_m.RDS")
data_holdout <-readRDS("Data/Clean/data_holdout_m.RDS")
...
write.csv(lasso_coeffs, paste0(output, "lasso_logit_coeffs_m.csv"))
...
logit_summary1_m <- logit_summary1
...
roc_2_m <- createRocPlot(roc_obj_holdout, "best_no_loss_roc_plot_holdout")
...
logit_summary2_m <- logit_summary2
...
roc_3_m <- createLossPlot(roc_obj, best_treshold, "rf_p_loss_plot")
roc_4_m <- createRocPlotWithOptimal(roc_obj, best_treshold, "rf_p_roc_plot")
...
summary_results_m <- summary_results
...
cali_m <- create_calibration_plot(data_holdout, 
