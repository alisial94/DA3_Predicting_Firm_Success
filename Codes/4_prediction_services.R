...
# Load the data
data <- readRDS("Data/Clean/bisnode_firms_clean.rds")
...
#data_holdout <- data[-train_indices, ]
 ...
 #                 $fast_growth_f)
 # 
#saveRDS(data_train,"Data/Clean/data_train_s.RDS")
#saveRDS(data_holdout,"Data/Clean/data_holdout_s.RDS")

data_train <- readRDS("Data/Clean/data_train_s.RDS")
data_holdout <-readRDS("Data/Clean/data_holdout_s.RDS") 
...
write.csv(lasso_coeffs, paste0(output, "lasso_logit_coeffs_s.csv"))
...
logit_summary1_s <- logit_summary1
#################################
#         Random forest         #
#################################
...
roc_2_s<-createRocPlot(roc_obj_holdout, "best_no_loss_roc_plot_holdout")
...
logit_summary2_s <- logit_summary2
...
roc_3_s<- createLossPlot(roc_obj, best_treshold, "rf_p_loss_plot")
roc_4_s<- createRocPlotWithOptimal(roc_obj, best_treshold, "rf_p_roc_plot")
...
summary_results_s <- summary_results
...
cali_s<- create_calibration_plot(data_holdout, 
