...
#Loading the data
data <- read_csv("https://raw.githubusercontent.com/alisial94/DA3_Predicting_Firm_Success/main/Data/Raw/cs_bisnode_panel.csv")

setwd("C:\\Users\\Rauhan Nazir\\Documents\\R_Codes\\DA3\\Assignment 3")
...
write_csv(data,"Data/Clean/bisnode_firms_clean.csv")
write_rds(data,"Data/Clean/bisnode_firms_clean.rds")
